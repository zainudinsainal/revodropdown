...
const ArrowRenderer = () => {
    return (index.h("span", { class: "arrow-wrapper" }, index.h("svg", { class: "arrow", "aria-hidden": "true", focusable: "false", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 320 512" }, index.h("path", { fill: "currentColor", d: "M41 288h238c21.4 0 32.1 25.9 17 41L177 448c-9.4 9.4-24.6 9.4-33.9 0L24 329c-15.1-15.1-4.4-41 17-41z" }))));
};
...
const RevoDropdown = class {
    ...
    renderDropdown() {
        return (index.h("div", { class: "revo-dropdown-list", ref: e => (this.dropdown = e) }, index.h("div", { [UUID]: this.uuid, class: "dropdown-inner", ref: e => (this.dropdownInner = e) }, this.hasFilter && !this.autocomplete ? (index.h(DropdownListFilter, { ref: e => (this.dropdownInput = e), source: this.source, filter: this.filter, dataLabel: this.dataLabel, value: this.currentFilter || '', filterValue: this.currentFilter || '', onFilterChange: e => {
                var _a;
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: '9ccb049ed09d7588897a83ad3dfb308d8e9eb691' }, props), index.h("label", { key: 'c97e4c8dcbbf87b03d3a8d69a22c4e01f9ee0e3e' }, this.placeholder), index.h("div", { key: '4d7f12bd93508dc5385f30645f25ebd06dd39e97', class: "rv-dr-root" }, this.multiple && this.renderMultiselected(), this.autocomplete ? this.renderAutocomplete() : this.renderSelect(), index.h("span", { key: 'a170b03f042f37b1eae4cc4ce17e787d65d65667', class: "actions" }, index.h(ArrowRenderer, { key: 'a1b09246d6e53b8a3b8bac52d56eb5f3a40d5fa3' })), index.h("fieldset", { key: '45ecfb0b2ec9b26fd7f7aef2af204186b3185981' }, index.h("legend", { key: 'a0f9e1ae462d123ca0f9191ae82fc11953206b37' }, index.h("span", { key: 'aa56112e44b30774b1351cf9b951af2c820abb47' }, this.placeholder)))), list));
    }
    showAutoComplete() {
...
const RevoDropdownList = class {
    ...
    render() {
        ...
        for (let i in this.sourceItems) {
            ...
            const li = index.h("li", Object.assign({ key: '12ec212d9d51dedfe992b57475b8ce5330acda0c' }, props), getItemLabel(item, this.dataLabel));
            items.push(li);
        }
        return index.h("ul", { key: '834691d43763a29c33a20f7bd2857fb008de012b' }, items);
    }
};
...
//# sourceMappingURL=revo-dropdown.revo-list.entry.cjs.js.map
