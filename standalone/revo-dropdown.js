...
import { g as getItemLabel, a as getItemValue, d as defineCustomElement$2 } from './revo-list2.js';
...
const RevoDropdown$1 = /*@__PURE__*/ proxyCustomElement(class RevoDropdown extends HTMLElement {
    ...
    static get style() { return revoDropdownStyleCss; }
}, [256, "revo-dropdown", {
        "dataLabel": [1, "data-label"],
        "value": [1032],
        "currentFilter": [1032, "current-filter"],
        "dataId": [1, "data-id"],
        ...
        "doOpen": [64],
        "doChange": [64]
    }, [[5, "mousedown", "onMouseUp"], [4, "keydown", "onKey"]], {
        "value": ["onValueChanged"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["revo-dropdown", "revo-list"];
    components.forEach(tagName => { switch (tagName) {
        case "revo-dropdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, RevoDropdown$1);
            }
            break;
        case "revo-list":
            if (!customElements.get(tagName)) {
...
const RevoDropdown = RevoDropdown$1;
const defineCustomElement = defineCustomElement$1;

export { RevoDropdown, defineCustomElement };
